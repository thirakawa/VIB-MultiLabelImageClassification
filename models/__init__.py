...
class ProbFeatureEmbedModel(nn.Module):
...
if __name__ == '__main__':
    ...
    model1_scratch = ProbFeatureEmbedModel('resnet50', num_classes=40, embed_dim=512, pretrained=False)
    model1_ftune   = ProbFeatureEmbedModel('resnet50', num_classes=40, embed_dim=512, pretrained=True)

    model2_scratch = ProbFeatureEmbedModel('resnext50_32x4d', num_classes=40, embed_dim=512, pretrained=False)
    model2_ftune   = ProbFeatureEmbedModel('resnext50_32x4d', num_classes=40, embed_dim=512, pretrained=True)

    model3_scratch = ProbFeatureEmbedModel('densenet169', num_classes=40, embed_dim=512, pretrained=False)
    model3_ftune   = ProbFeatureEmbedModel('densenet169', num_classes=40, embed_dim=512, pretrained=True)

    model4_scratch = ProbFeatureEmbedModel('regnet_y_32gf', num_classes=40, embed_dim=512, pretrained=False)
    model4_ftune   = ProbFeatureEmbedModel('regnet_y_32gf', num_classes=40, embed_dim=512, pretrained=True)
